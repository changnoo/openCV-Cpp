...
```
Using the skills I learned throughout this tutorial, I was able to make a program that identifies an object's colour, draws a contour box around the object, and draw circles on the screen. The result is shown below:

![xd (1)](https://user-images.githubusercontent.com/56273897/127938916-0a107e91-6fbd-4962-b119-25ca66eada7d.gif)
